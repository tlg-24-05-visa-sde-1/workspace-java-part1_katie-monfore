...
//         testElectionDay();
    ...
    public static void testEarlyRetirement() {
        LocalDate bday = LocalDate.of(1988, 11, 20);
    ...
    public static void testLaborDay() {
        LocalDate sept1 = LocalDate.of(1988, 11, 20);
        System.out.println(sept1.getDayOfWeek());
        LocalDate laborDay = sept1.with(TemporalAdjusters.nextOrSame(MONDAY)).plusDays(1);
    ...
    public static void testElectionDay() {
        ...
        LocalDate electionDay = nov1.with(TemporalAdjusters.next(TUESDAY));
