...
//         passByValue();
    ...
    private static void passByValue() {
        ...
        System.out.println("Client: after the call, x is " + x);  //it's STILL 4 because it's a copy
    }
    ...
    private static void passByReference() {
        ...
        System.out.println("Client: after the call, the marker is " + m1.getColor()); // it's blue meow!!!
    }
}